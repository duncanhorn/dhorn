...
namespace dhorn
{
    namespace tests
    {
        ...
        {
            using animation_type = dhorn::discrete_animation<float>;
            ...
            TEST_METHOD(NoValueTest)
            {
                ...
                Assert::IsTrue(state == animation_state::completed);
            ...
            TEST_METHOD(SingleValueTest)
            {
                ...
                Assert::IsTrue(state == animation_state::running);
                Assert::AreEqual(42.0f, value);
        ...
        {
            using animation_type = dhorn::linear_animation<float>;
