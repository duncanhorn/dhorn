 ...
 * built on top of this traits type, such as `utf_iterator` which is used to read from encoded strings, and
 * utf_output_iterator, which is used to write to encoded strings.
 */
#pragma once
