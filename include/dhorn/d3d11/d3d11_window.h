...
#pragma endregion
        ...
        protected:
            ...
            virtual void create_swap_chain(const dhorn::rect<size_t> &size)
            {
                assert(this->_device);
            ...
            virtual void create_depth_stencil(const dhorn::rect<size_t> &size)
            {
            ...
            virtual void set_viewports(const dhorn::rect<size_t> &size)
            {
